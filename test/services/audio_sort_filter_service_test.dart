...
void main() {
  ...
  group("filter and sort audio by multiple filter and multiple SortingOption's",
      () {
    late AudioSortFilterService audioSortFilterService;
  ...
  group('filter function test: ignoring case, filter audio list on validVideoTitle only', () {
    late Audio audioOne;
    late Audio audioTwo;
    late Audio audioThree;
    late Audio audioFour;
    late List<Audio> audioLst;
    late AudioSortFilterService audioSortFilterService;
    setUp(() {
      audioOne = Audio.fullConstructor(
        enclosingPlaylist: null,
        movedFromPlaylistTitle: null,
        movedToPlaylistTitle: null,
        copiedFromPlaylistTitle: null,
      ...
      audioTwo = Audio.fullConstructor(
        enclosingPlaylist: null,
        movedFromPlaylistTitle: null,
        movedToPlaylistTitle: null,
        copiedFromPlaylistTitle: null,
      ...
      audioThree = Audio.fullConstructor(
        enclosingPlaylist: null,
        movedFromPlaylistTitle: null,
        movedToPlaylistTitle: null,
        copiedFromPlaylistTitle: null,
      ...
      audioFour = Audio.fullConstructor(
        enclosingPlaylist: null,
        movedFromPlaylistTitle: null,
        movedToPlaylistTitle: null,
        copiedFromPlaylistTitle: null,
  ...
  group('filter function test: not ignoring case, filter audio list on validVideoTitle only',
      () {
    late Audio audioOne;
    late Audio audioTwo;
    late Audio audioThree;
  ...
  group(
      'filter function test: ignoring case, filter audio list on validVideoTitle or compactVideoDescription',
      () {
    late Audio audioOne;
    late Audio audioTwo;
    late Audio audioThree;
  ...
  group(
      'filter function test: not ignoring case, filter audio list on validVideoTitle or compactVideoDescription',
      () {
    late Audio audioOne;
    late Audio audioTwo;
    late Audio audioThree;
