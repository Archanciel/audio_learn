  ...
  group('sortAudioLstBySortingOption', () {
    ...
    test('sort by title', () {
      final Audio zebra = Audio.fullConstructor(
        ...
        isPlayingOnGlobalAudioPlayerVM: false, isPaused: true, audioPausedDateTime: null,
    ...
    test('sort by title starting with non language chars', () {
      ...
      Audio nineTitle = Audio.fullConstructor(
        ...
        isAudioMusicQuality: false,
        audioPlaySpeed: kAudioDefaultPlaySpeed,
        isPlayingOnGlobalAudioPlayerVM: true, isPaused: true, audioPausedDateTime: DateTime(2023, 3, 24, 20, 5, 32),
